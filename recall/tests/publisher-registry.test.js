...
assert.strictEqual(getPublisher("notion"), notionPublisher);
assert.strictEqual(getPublisher("slack"), slackPublisher);
assert.strictEqual(getPublisher("teamwork"), teamworkPublisher);
